...
import TablePhanphatDen from "../tables/subtables/TablePhanphatDen";

const DL1CongcuPhanphat = ({ daily1Id, setActive }) => {
  ...
  const fetchDsPhanphat = async () => {
    setLoading(true);
    const { dsphanphat } = await apiDaily1.dsPhanphat(daily1Id);
    setDsPhanphat(
...
export default DL1CongcuPhanphat;
