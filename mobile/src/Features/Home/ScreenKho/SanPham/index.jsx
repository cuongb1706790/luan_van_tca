        ...
        >
          ...
          >
            ...
            <Text style={{ color: "white" }}>
              Giá : {formatNumber.format(data.sanpham.gia)}đ
            </Text>
            <Text style={{ color: "white" }}>Mô tả :{data.sanpham.mota}</Text>
            <Text style={{ color: "white" }}>S.Lượng yêu cầu :{data.soluong}</Text>
            <Text style={{ color: "white" }}>S.Lượng hoàn thành :{data.soluonghoanthanh}</Text>
            <Text style={{ color: "white" }}>S.Lượng đã giao :{data.dagiao}</Text>
